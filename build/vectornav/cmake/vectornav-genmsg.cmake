...
message(STATUS "vectornav: 1 messages, 0 services")

set(MSG_I_FLAGS "-Ivectornav:/home/ecl-109/uuv_ws/src/Argonaut/vectornav/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/ecl-109/uuv_ws/src/Argonaut/vectornav/msg/Ins.msg" NAME_WE)
add_custom_target(_vectornav_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "vectornav" "/home/ecl-109/uuv_ws/src/Argonaut/vectornav/msg/Ins.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(vectornav
  "/home/ecl-109/uuv_ws/src/Argonaut/vectornav/msg/Ins.msg"
  "${MSG_I_FLAGS}"
...
### Generating Messages
_generate_msg_eus(vectornav
  "/home/ecl-109/uuv_ws/src/Argonaut/vectornav/msg/Ins.msg"
  "${MSG_I_FLAGS}"
  "/opt/ros/noetic/share/std_msgs/cmake/../msg/Header.msg"
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/vectornav
)

### Generating Services

### Generating Module File
_generate_module_eus(vectornav
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/vectornav
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(vectornav_generate_messages_eus
  DEPENDS ${ALL_GEN_OUTPUT_FILES_eus}
)
add_dependencies(vectornav_generate_messages vectornav_generate_messages_eus)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/ecl-109/uuv_ws/src/Argonaut/vectornav/msg/Ins.msg" NAME_WE)
add_dependencies(vectornav_generate_messages_eus _vectornav_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(vectornav_geneus)
add_dependencies(vectornav_geneus vectornav_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS vectornav_generate_messages_eus)
...
### Generating Messages
_generate_msg_nodejs(vectornav
  "/home/ecl-109/uuv_ws/src/Argonaut/vectornav/msg/Ins.msg"
  "${MSG_I_FLAGS}"
  "/opt/ros/noetic/share/std_msgs/cmake/../msg/Header.msg"
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/vectornav
)

### Generating Services

### Generating Module File
_generate_module_nodejs(vectornav
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/vectornav
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(vectornav_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(vectornav_generate_messages vectornav_generate_messages_nodejs)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/ecl-109/uuv_ws/src/Argonaut/vectornav/msg/Ins.msg" NAME_WE)
add_dependencies(vectornav_generate_messages_nodejs _vectornav_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(vectornav_gennodejs)
add_dependencies(vectornav_gennodejs vectornav_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS vectornav_generate_messages_nodejs)
...
if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/vectornav)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/vectornav
    DESTINATION ${geneus_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_eus)
  add_dependencies(vectornav_generate_messages_eus std_msgs_generate_messages_eus)
endif()
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/vectornav)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/vectornav
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(vectornav_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/vectornav)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/vectornav\")")
  # install generated code
  install(
