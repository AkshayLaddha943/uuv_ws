...
from uuv_auv_control_allocator import AUVCommand
...
class ROV_NMB_SMController(DPControllerBase):
    ...
    def __init__(self):
        ...
        #The following rosservices can be used to set different controller parameters
    ...
    def _reset_controller(self):
        super(ROV_NMB_SMController, self)._reset_controller()   #calls the reset controller method of the parent class
        self._first_pass = True
        self._t_init = 0.0
        self._s_linear_b_init = np.array([0, 0, 0])
        self._s_angular_b_init = np.array([0, 0, 0])
    ...
    def update_controller(self):
        ...
        # Get trajectory errors (reference - actual) (position and velocity error in linear and angular directions)
    ...
    def sat(value, epsilon=0.5):
        assert epsilon >= 0, 'Saturation constant must be greater or equal to zero'
        if epsilon == 0:
