...
class TrajectoryMarkerPublisher:
    def __init__(self):
        ...
        self._namespace = rospy.get_namespace().rstrip('/')
        ...
        """Uncomment above lines for geometric_tracking_control"""    

        # self._trajectory_sub = rospy.Subscriber(
        #     os.path.join(self._namespace, 'dp_controller/trajectory'), Trajectory, self._update_trajectory)

        # self._waypoints_sub = rospy.Subscriber(
        #     os.path.join(self._namespace, 'dp_controller/waypoints'), WaypointSet, self._update_waypoints)

        
        # self._reference_sub = rospy.Subscriber(
        #     os.path.join(self._namespace, 'dp_controller/reference'), TrajectoryPoint, self._reference_callback)
