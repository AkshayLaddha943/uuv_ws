...
if("TRUE" STREQUAL "TRUE")
  set(ndt_omp_SOURCE_PREFIX /home/ecl-109/uuv_ws/src/ndt_omp)
  set(ndt_omp_DEVEL_PREFIX /home/ecl-109/uuv_ws/devel/.private/ndt_omp)
  set(ndt_omp_INSTALL_PREFIX "")
  set(ndt_omp_PREFIX ${ndt_omp_DEVEL_PREFIX})
else()
  set(ndt_omp_SOURCE_PREFIX "")
  set(ndt_omp_DEVEL_PREFIX "")
  set(ndt_omp_INSTALL_PREFIX /home/ecl-109/uuv_ws/install)
...
if(NOT "/home/ecl-109/uuv_ws/src/ndt_omp/include " STREQUAL " ")
  set(ndt_omp_INCLUDE_DIRS "")
  set(_include_dirs "/home/ecl-109/uuv_ws/src/ndt_omp/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ndt_omp' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ecl-109/uuv_ws/src/ndt_omp/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ecl-109/uuv_ws/devel/.private/ndt_omp/lib;/home/ecl-109/uuv_ws/devel/lib;/opt/ros/noetic/lib)
